...
aktive_abfrage_ids = r'(?P<abfrage_id>\d+)/(?P<abfrage_nummer>\d+)/(?P<erster_versuch>[01])/(?P<anzahl_versuche>\d+)/$'
...
urlpatterns = [
    ...
    url(r'^aktive_abfrage/' + aktive_abfrage_ids, views_abfrage.aktive_abfrage, name='aktive_abfrage'),
